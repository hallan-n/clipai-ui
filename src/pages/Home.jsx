        ...
        <div className='h-screen bg-gradient-to-br from-primary-3 via-primary-2 to-primary-3'>
            <div className='flex items-center justify-center w-full h-full p-4'>
                <div className='mt-20 sm:mt-0'>
                    ...
                    <p className='text-white text-center text-2xl mt-6'>Monitore os <b>criadores de conteúdo</b> e faça os seus <br /> cortes de forma <b>totalmente automática.</b></p>

                        <InputGroup className="h-12 ps-4 mt-6 border-none bg-primary-4 text-primary-1">
                            <InputGroupInput className="p-0 border-none placeholder:text-primary-1"  type="password" placeholder="Cole a URL do vídeo/livestream"/>
                    ...
                    <p className='font-bold text-white text-center my-6'>Aproveite todas as funcionalidades</p>
                    <div className="flex justify-center flex-wrap gap-4 mt-4 lg:flex-nowrap">
                        <div className="flex flex-col gap-4 items-center justify-center text-center text-white border-4 border-primary-4 rounded-lg p-4 w-44">
